...
--
-- Table structure for table `utente_rest`
--

DROP TABLE IF EXISTS `utente_rest`;
/*!40101 SET @saved_cs_client = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `utente_rest`
(
    `id`    int unsigned NOT NULL,
    `token` varchar(36) DEFAULT NULL,
    PRIMARY KEY (`id`),
    KEY `fk_utente_token_idx` (`id`),
    CONSTRAINT `fk_utente_token_idx` FOREIGN KEY (`id`) REFERENCES `utente` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

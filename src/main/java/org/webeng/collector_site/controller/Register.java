...
public class Register extends CollectorsBaseController {
    ...
    private void action_default(HttpServletRequest request, HttpServletResponse response) throws TemplateManagerException {
        ...
        result.activate("register.ftl", request, response);
    }
    ...
    private void action_register(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            utenteDAO = ((CollectorsDataLayer) request.getAttribute("datalayer")).getUtenteDAO();
        ...
        if (utente != null) {
            ...
            try {
                ...
                utente.setPassword(SecurityHelpers.encryptPassword(request.getParameter("password")));

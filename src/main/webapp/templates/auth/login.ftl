                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab5">
                                    ...
                                    <div class="text-center pt-3">
                                        <p class="text-dark mb-0">Non sei registrato?<a href="register"
                                ...
                                <div class="tab-pane" id="tab6">
                                    ...
                                    <div id="login-otp" class="justify-content-around mb-5">
                                        <label for="txt1"></label><input class="form-control text-center w-15" id="txt1"
                                                                         maxlength="1">
                                        <label for="txt2"></label><input class="form-control text-center w-15" id="txt2"
                                                                         maxlength="1">
                                        <label for="txt3"></label><input class="form-control text-center w-15" id="txt3"
                                                                         maxlength="1">
                                        <label for="txt4"></label><input class="form-control text-center w-15" id="txt4"
                                                                         maxlength="1">
                                    </div>

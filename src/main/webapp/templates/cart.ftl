                                        ...
                                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                            ...
                                            <div class="dropdown-footer">
                                                <a class="btn btn-primary btn-pill w-sm btn-sm py-2"
                                                   href="checkout.html"><i class="fe fe-check-circle"></i> Checkout</a>
                    ...
                    <ul class="side-menu">
                        ...
                        <li>
                            <a class="side-menu__item has-link" href="landing-page.html" target="_blank"><i
                                        ...
                                        class="side-menu__label">Landing Page</span><span
                            ...
                            <ul class="slide-menu">
                                ...
                                <li class="sub-slide">
                                    ...
                                    <ul class="sub-slide-menu">
                                        ...
                                        <li><a href="form-validation.html" class="sub-slide-item"> Form Validation</a>
                                        </li>
                                ...
                                <li class="sub-slide">
                                    ...
                                    <ul class="sub-slide-menu">
                                        ...
                                        <li><a href="construction.html" class="sub-slide-item"> Under Construction</a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        class="side-menu__icon fe fe-folder"></i><span class="side-menu__label">File Manager</span><span
                                    ...
                                    <ul class="sub-slide-menu">
                                        ...
                                        <li class="sub-slide2">
                                            <a class="sub-side-menu__item2" href="javascript:void(0)"
                                               data-bs-toggle="sub-slide2"><span class="sub-side-menu__label2">Submenu-2.3</span><i
                            ...
                            <div class="card cart">
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 text-end"><a href="javascript:void(0)"
                                                                                   class="btn btn-default disabled btn-md">Update
                                                Cart</a></div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless text-nowrap mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end"><span class="fw-bold text-success">- $55</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="text-start">Delivery Charges</td>
                                                <td class="text-end"><span class="fw-bold text-green">0 (Free)</span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end"><span class="fw-bold text-success">- $15%</span>
                                                </td>
                                            </tr>
                                            <tr>

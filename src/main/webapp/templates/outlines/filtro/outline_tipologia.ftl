...
<dd><span class="filtro-link" onclick="ricerca('CANTANTE', '#table-tbody-autori')">CANTANTE</span></dd>
<dd><span class="filtro-link" onclick="ricerca('MUSICISTA', '#table-tbody-autori')">MUSICISTA</span></dd>
